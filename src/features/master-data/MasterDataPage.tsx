...
import { AlertTriangle, CheckCircle2, FileSpreadsheet, History, RotateCcw, Upload, XCircle } from 'lucide-react'
...
type Tab = 'maestro' | 'importar' | 'historial' | 'detalle'
...
export function MasterDataPage() {
  ...
  async function refreshAll() {
    ...
    try {
      await Promise.all([loadSkus(), loadImports()])
    } catch (error) {
